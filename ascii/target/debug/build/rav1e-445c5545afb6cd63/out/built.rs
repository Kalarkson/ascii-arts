...
#[allow(dead_code)]
pub static RUSTC_VERSION: &str = "rustc 1.85.1 (4eb161250 2025-03-15) (Arch Linux rust 1:1.85.1-1)";
#[doc=r#"The output of `rustdoc -V`; empty string if `rustdoc -V` failed to execute"#]
#[allow(dead_code)]
pub static RUSTDOC_VERSION: &str = "rustdoc 1.85.1 (4eb161250 2025-03-15) (Arch Linux rust 1:1.85.1-1)";
